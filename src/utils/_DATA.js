let users = {
  junior: {
    id: "junior",
    name: "Rwotomiya Nathan",
    avatarURL: "/images/junior.jpg",
    tweets: [
  ...
  yeni: {
    id: "yeni",
    name: "Samuel Baker Eyena",
    avatarURL: "/images/omiya.jpg",
    tweets: [
